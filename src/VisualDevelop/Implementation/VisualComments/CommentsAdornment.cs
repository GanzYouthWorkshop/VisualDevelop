    ...
    internal sealed class CommentsAdornment : ITagger<ErrorTag>, IDisposable
    {
        ...
        internal void OnLayoutChanged(object sender, TextViewLayoutChangedEventArgs e)
        {
            try
            {
                ...
                _errorTags.Clear();
                TagsChanged?.Invoke(this, new SnapshotSpanEventArgs(new SnapshotSpan(m_View.TextSnapshot, new Span(0, m_View.TextSnapshot.Length))));
        ...
        private void _timer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            Application.Current.Dispatcher.Invoke(() =>
            {
                ...
                m_TextDocumentFactory.TryGetTextDocument(m_View.TextBuffer, out ITextDocument textDocument))
                {
