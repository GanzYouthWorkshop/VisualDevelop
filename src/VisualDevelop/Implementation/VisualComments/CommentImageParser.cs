...
namespace GEV.VisualDevelop.Implementation.VisualComments
{
    internal static class CommentImageParser
    {
        static CommentImageParser()
        {
            ...
            m_CsharpImageCommentRegex = new Regex(cSharpCommentPattern + xmlImageTagPattern, RegexOptions.Compiled);
            ...
            if (!string.IsNullOrEmpty(lineText))
            {
                ...
                switch (contentTypeName)
                {
                    ...
                    case ContentTypes.TypeScript:
                        match = m_CsharpImageCommentRegex.Match(lineText);
                        break;
        ...
        private static Regex m_CsharpImageCommentRegex;
